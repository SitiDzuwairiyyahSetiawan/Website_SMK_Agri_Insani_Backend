...
<div class="page-header">
    ...
    <div>
        ...
        <p class="page-subtitle">
            Update foto dan informasi galeri sekolah
        </p>
                ...
                <div class="col-lg-8">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi"
                                  ...
                                  placeholder="Tulis deskripsi galeri...">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                ...
                <div class="col-lg-4">
                            ...
                            <div id="imagePreview"
                                ...
                                @else
                                    ...
                                    <div class="upload-placeholder">
                                        ...
                                        <p>
                                            Upload gambar galeri terbaikmu
                                        </p>
                    ...
                    <div class="tips-card">
                        ...
                        <ul class="tips-list">
                            ...
                            <li>
                                Update:
                                {{ $galeri->updated_at->diffForHumans() }}
                            </li>
