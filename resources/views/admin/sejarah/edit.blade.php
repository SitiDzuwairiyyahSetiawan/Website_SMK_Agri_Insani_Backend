...
<div class="page-header">
    ...
    <div>
        ...
        <p class="page-subtitle">
            Update sejarah website sekolah
        </p>
                ...
                <div class="col-lg-8">
                    ...
                    <div>
                        ...
                        <textarea name="konten"
                                  ...
                                  placeholder="Tulis sejarah sekolah...">{{ old('konten', $sejarah->konten) }}</textarea>
                ...
                <div class="col-lg-4">
                            ...
                            <div id="imagePreview"
                                ...
                                @else
                                    ...
                                    <div class="upload-placeholder">
                                        ...
                                        <p>
                                            Upload gambar sejarah terbaikmu
                                        </p>
                    ...
                    <div class="modern-card mb-4">
                        ...
                        <div class="card-body-modern">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ $sejarah->created_at->format('d M Y - H:i') }}"
                                       readonly>
                            ...
                            <div>
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ $sejarah->updated_at->diffForHumans() }}"
                                       readonly>
                    ...
                    <div class="tips-card">
                        ...
                        <ul class="tips-list">
                            ...
                            <li>
                                Ceritakan sejarah sekolah secara runtut
                            </li>

                            <li>
                                Tambahkan gambar terbaik agar lebih menarik
                            </li>

                            <li>
                                Pastikan informasi sejarah valid dan terbaru
                            </li>
